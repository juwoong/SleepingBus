package kr.tamiflus.sleepingbus.animations;
 ...
 */
public class OnOffChangeListener implements AppBarLayout.OnOffsetChangedListener {
    ...
    private View title, titleContainer;

    public OnOffChangeListener(View title, View titleContainer) {
        this.title = title;
